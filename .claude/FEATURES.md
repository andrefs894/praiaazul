...
Stored in localStorage as `praia_azul_perfil`. Synced to Supabase if the user signs in (see feature 8).
...
## 5. Favorites
Save favorite beaches. Stored in localStorage as `praia_azul_favoritas` (number[]).
